...
public class subtitleJMenu extends JMenu implements ActionListener  {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == addSub){
			if(MainFrame.getInstance().getMediaPlayer() != null){
				...
				//display JFilechooser for user to select a srt file
		...
		//go through sub tracks and set the selected track
		int i = 1;
	...
	/**
	 * Unchecks all radioButtonMenuItems
	 */
	...
	/**
	 * sets up the items inside this JMenu
	 * @param cVideo
	 */

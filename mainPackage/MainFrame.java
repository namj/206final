...
public class MainFrame extends JFrame implements ActionListener{
	...
	private PrimaryPanel container;
	...
	private MainFrame() {
		...
		container = new PrimaryPanel(ourMediaPlayer);
		...
		openButton = MainFrameHelper.setImageButton(new ImageIcon(this.getClass().getResource("resources/open_button.gif")));
	...
	private JMenuBar setUpMenuBar() {
		...
		JMenu file, edit, help, options,_space, _space2, _space3;
	...
	/**
	 * mouse adapter which detects clicking on media filename field and opens JFilechooser if so
	 */
	...
	/**
	 * displays JFilechooser for directory to save outputfile.
	 * and returns result of JFilechooser
	 * @return
	 */
